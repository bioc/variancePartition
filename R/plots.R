...
setGeneric("plotVarPart", signature="obj",
	function( obj, col=c(ggColorHue(ncol(obj)-1), "#bebebe99"), label.angle=20, ylim=c(0,100), main="",...)
...
.plotVarPart <- function( obj, col=c(ggColorHue(ncol(obj)-1), "#bebebe99"), label.angle=20, ylim=c(0,100), main="", ylab=''){
